        ...
        <Box sx={{ width: '100%', height: '100%', p: 3, boxSizing: 'border-box', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 5 }}>
            ...
            {fase === 'mostrar' && (
                <>
                    ...
                    <Typography variant="body1" textAlign="center">Observa bien estas figuras y memorizalas</Typography>
            ...
            {fase === 'recordar' && (
                <>
                    <Typography variant="h4" textAlign="center">🎨¡Oh no Falta una figura!</Typography>
                    <Typography variant="body1" textAlign="center"> Observa con mucha atencion y trata de recordar cual falta </Typography>
                    {renderGrid(figurasIncompletas)}
                    <Button variant="contained" onClick={avanzar} sx={{ mt: 3, fontSize: '1.2rem', px: 4 }}>¿Recuerdas la figura?</Button>
                </>
            )}

            {fase === 'seleccionar' && (
                <>
                    <Typography variant="h4" textAlign="center">🎨¡RECUERDAS LA FIGURA!</Typography>
                    <Typography variant="body1" textAlign="center">Indica cual era la figura que faltaba </Typography>
