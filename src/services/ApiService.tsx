...
// Obtener actividades de una sesión por ID
...
// Registrar resultado de una actividad completada por el usuario
...
// Verificar si ya se completó una actividad de una sesión por usuario
