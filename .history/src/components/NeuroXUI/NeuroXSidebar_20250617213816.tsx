    ...
    import { useMediaQuery, Box, IconButton, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Divider, Typography } from '@mui/material';
    ...
    // Detectar si es desktop (mayor que 768px)
    ...
    const content = (
        ...
        {userRole === 'user' && (
            ...
            aria-label="Cambiar modo de usuario"
            role="button"
            tabIndex={0}
            onKeyDown={(e) => {
    ...
    // Si es desktop, mostrar sidebar fijo
    if (isDesktop) {
        return (
        <Box
            sx={{
    ...
    return (
        ...
        <Box sx={{ display: 'flex', justifyContent: 'flex-end', px: 1 }}>
            <IconButton onClick={onClose} sx={{ color: 'white' }} aria-label="Cerrar menú">
            <CloseIcon />
            </IconButton>
        </Box>
        {content}
