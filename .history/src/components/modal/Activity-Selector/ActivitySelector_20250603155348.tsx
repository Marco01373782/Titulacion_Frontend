    ...
    title: string;
    type: { name: string };
    difficulty: string; // cambio aquí: ahora es string directamente
    }
    ...
    loading?: boolean;  // prop opcional para deshabilitar mientras carga
    }
    ...
    // Inicializa selección por tipo: un activityId o null
    ...
    // Agrupa actividades por tipo para renderizar
