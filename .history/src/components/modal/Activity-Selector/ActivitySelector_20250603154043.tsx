    ...
    // Estado para selección: una actividad por tipo
    // Inicializamos con las actividades que ya estaban seleccionadas
    ...
    // Agrupar actividades por tipo para mostrar agrupadas
