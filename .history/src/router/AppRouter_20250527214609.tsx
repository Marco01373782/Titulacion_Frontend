  ...
  return (
    <Router>
      <Routes>
        ...
        {/* Rutas dentro de la app *//* Rutas dentro de la app *//* Rutas dentro de la app *//* Rutas dentro de la app *//* Rutas dentro de la app */}
        <Route path="/app" element={<MainLayout />}>
         {/* Ruta protegida para user *//* Ruta protegida para user *//* Ruta protegida para user *//* Ruta protegida para user *//* Ruta protegida para user */}
          <Route
            path="user-dashboard"
            element={
          ...
          {/* Ruta protegida para admin *//* Ruta protegida para admin *//* Ruta protegida para admin *//* Ruta protegida para admin *//* Ruta protegida para admin *//* Ruta protegida para admin */}
          <Route
          ...
          />
              ...
              {/*rutas para las actividades creadas*//*rutas para las actividades creadas*//*rutas para las actividades creadas*//*rutas para las actividades creadas*/}
