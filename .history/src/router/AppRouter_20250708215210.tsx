  ...
  // Actividades
  import NumeroFaltante from '../actividades/ESTANDAR/FiguraFaltante';
  // Memoria
    ...
    return (
      <Router>
        <Routes>
          ...
          >
            <Route path="numero-faltante" element={<NumeroFaltante />} />
                                                                                                {/*Memoria */}
            ...
            <Route path="atencion-intermedio" element={<AtencionIntermedio />} />
