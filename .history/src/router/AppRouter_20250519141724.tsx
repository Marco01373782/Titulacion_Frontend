...
import Activities from '../pages/ADMIN/actividades/ActivityList';
import CrearActividad from '../pages/ADMIN/actividades/CrearActividad'; // ← después lo creamos
import EditarActividad from '../pages/ADMIN/actividades/EditarActividad'; // ← después también
