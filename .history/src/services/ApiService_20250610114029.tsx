...
// ApiService.ts
export const getActivitiesBySesionId = async (sessionId: number) => {
  try {
    console.log("Obteniendo actividades para la sesión ID:", sessionId);
    const response = await axios.get(`/session-activities/by-session/${sessionId}`);
