        ...
        <Box sx={{
            ...
            {step === 'intro' && (
                <Paper elevation={4} sx={{ p: 4, textAlign: 'center' }}>
                    ...
                    <Typography variant="h5" sx={{ mb: 4 }}>
                        Memoriza el orden de las imágenes que aparecerán y luego selecciona cuáles viste. Tienes 5 segundos.
                    </Typography>
            ...
            {step === 'memorize' && (
                <Paper elevation={4} sx={{ p: 4, textAlign: 'center', maxWidth: 800 }}>
                    <Typography variant="h4" sx={{ mb: 3 }}>¡Memoriza el orden de estas imágenes!</Typography>
