...
const ColoresSecuencia = ({ onFinish }: { onFinish?: (result: string) => void }) => {
    ...
    return (
        <Box sx={{
            width: '100%', height: '100%', p: isMobile ? 2 : 4, boxSizing: 'border-box',
            display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'
        }}>
            <Paper elevation={4} sx={{
                width: '100%', maxWidth: 1000, minHeight: '85vh',
                p: isMobile ? 2 : 5, borderRadius: 4,
                ...
                {fase === 'inicio' && (
                    <>
                        <Typography sx={{ fontSize: isMobile ? '1rem' : '1.2rem', textAlign: 'center', color: '#444' }}>
                            Memoriza los colores que se mostrarán uno a uno. Luego repítelos en el mismo orden.
                        </Typography>
                ...
                {fase === 'mostrar' && (
                    <>
                        <Typography>Observa la secuencia:</Typography>
