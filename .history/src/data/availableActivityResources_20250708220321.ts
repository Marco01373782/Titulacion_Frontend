    ...
    const availableActivityResources = [
            ...
            {label:'Figura - Faltante', value: '/actividades/figura-faltante'},//completa y lista jaja secuencia-colores
            {label:'Secuancia- de - Colores', value: '/actividades/secuencia-colores'}, //completa y lista jaja 
