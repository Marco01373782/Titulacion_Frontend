...
const Estadisticas: React.FC = () => {
    ...
    const [activeTab, setActiveTab] = useState<'general' | 'sesiones' | 'evolucion' | 'promedios' | 'tiempo' | 'comparativo'>('general');
    ...
    return (
        <div className="estadisticas-container">
            <nav className="estadisticas-nav">
                ...
                <button className={activeTab === 'tiempo' ? 'active' : ''} onClick={() => setActiveTab('tiempo')}>
                    ⏱ Tiempo promedio por tipo
                </button>
                
                <button className={activeTab === 'comparativo' ? 'active' : ''} onClick={() => setActiveTab('comparativo')}>
                    📤 Exportar
                </button>
        /*<button disabled>📤 ...</button>
            ...
            <div className="comparativo-container">
                <ResumenComparativo sesiones={sesiones} />
            </div>
)}
