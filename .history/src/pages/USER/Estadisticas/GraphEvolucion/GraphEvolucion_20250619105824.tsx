    ...
    return (
        <Paper
            ...
            sx={{
                ...
                minHeight: isMobile ? 550 : 450,
                bgcolor: '#ffffff',
                display: 'flex',
                flexDirection: 'column',
                height: isMobile ? 550 : 450, // 🔥 le doy altura fija completa
            }}
        >
            <Typography
            ...
            {data.length === 0 ? (
                ...
                <Box flexGrow={1}>  {/* AQUI el truco para que el ResponsiveContainer llene correctamente */}
