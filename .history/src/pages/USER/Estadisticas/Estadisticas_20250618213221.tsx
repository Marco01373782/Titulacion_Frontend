...
import {
  Box, Typography, Tabs, Tab, Grid, Paper, Avatar, Button, CircularProgress
} from '@mui/material';
import {
  getSesionesUsuario,
...
const Estadisticas: React.FC = () => {
  ...
  return (
    <Box sx={{ width: '100%', height: '100%', bgcolor: '#f5f7fa', p: 2 }}>
      <Paper elevation={3} sx={{ p: 2, mb: 2 }}>
        <Typography variant="h4" fontWeight="bold" color="primary">
          Panel de Estadísticas
        </Typography>
        <Typography variant="body1" mt={1}>
          Aquí puedes visualizar tu desempeño, progreso y evolución en las sesiones realizadas. 🚀
        </Typography>
      </Paper>
                      ...
                      <Grid item xs={12} sm={6} md={4} key={s.id}>
                        <Paper
                          ...
                          sx={{
                            ...
                            boxShadow: 3, transition: 'all 0.3s',
                        ...
                        >
                          <Box display="flex" justifyContent="space-between" alignItems="center">
                            ...
                            <Avatar
                              sx={{
                                bgcolor: getColorByScore(s.result),
                                color: 'white'
                              }}
                            >
                              {Math.round(s.result)}
