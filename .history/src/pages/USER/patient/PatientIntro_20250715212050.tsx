    ...
    import HomeAdults from '../../../assets/imagenes/home.webp';
    ...
    return (
        ...
        <Typography variant="body1" color="text.secondary" maxWidth={600} mb={3} fontWeight={600}>
        ...
        <Typography variant="body1" color="text.secondary" maxWidth={650} mb={4} fontWeight={700}>
