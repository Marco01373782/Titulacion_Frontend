  ...
  return (
    <Box width="100%" height="100%" p={isMobile ? 2 : 4}>
      ...
      <Typography variant="body1" color="text.secondary" mb={4}>
        El modo individual permite al cuidador o fmilar acompañar al usuario en un camino progresivo de estimulación cognitiva personalizada.
      ...
      >
        ...
        >
          <CardContent>
            ...
            <Typography variant="body1" color="text.secondary">
              El sistema permite seleccionar manualmente el nivel de dificultad de las sesiones según las capacidades del usuario. De esta forma, el entrenamiento se ajusta a su ritmo y necesidades específicas, ofreciendo sesiones personalizadas desde nivel básico hasta avanzado.
            </Typography>
          </CardContent>
        </Card>
      </Box>
