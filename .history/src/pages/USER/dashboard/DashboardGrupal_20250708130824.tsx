    ...
    return (
        ...
        <Typography variant="body1" color="text.secondary" mb={4}>
           El modo individual permite al cuidador o familiar acompañar al adulto mayor en un camino  colectivas guiadas por un facilitador. No hay registro de progreso, ofreciendo sesiones libres, dinámicas y recreativas que promueven la participación social.
        </Typography>
        ...
        >
            ...
            <CardContent>
                ...
                <Typography variant="body1" color="text.secondary">
                Las actividades se pueden repetir libremente, sin registros, límites ni seguimiento de progreso.
                </Typography>
            </CardContent>
            </Card>
