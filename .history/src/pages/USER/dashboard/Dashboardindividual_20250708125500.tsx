  ...
  return (
    <Box width="100%" height="100%" p={isMobile ? 2 : 4}>
      ...
      <Typography variant="body1" color="text.secondary" mb={4}>
        El modo individual permite al cuidador o familiar acompañar al adulto mayor en un camino entretenido, de estimulación cognitiva.
        Tolas las sesiones estan disponibles .
      </Typography>
