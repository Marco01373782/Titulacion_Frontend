      ...
      >
        ...
        >
          <CardContent>
            ...
            <Typography variant="body1" color="text.secondary">
              Las actividades don de dos tipos, las que trabajan la memoria a traves de actividades y juegos, por otro lado las que trabajan la memoria atraves de videos entretenidos y preguntas finales de razonamiento. 
            </Typography>
          </CardContent>
        </Card>
      </Box>
