    ...
    return (
        ...
        <Typography variant="body1" color="text.secondary" mb={4}>
           El modo libre permite al cuidador o familiar acompañar a un grupo de adultos mayores en sesiones colectivas. No hay registro de progreso, ofreciendo sesiones libres, dinámicas y recreativas que promueven la participación social.
        </Typography>

        <Divider sx={{ my: 3 }}>
            <Chip label="Características del modo libre" color="secondary" />
        </Divider>
