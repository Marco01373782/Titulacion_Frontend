    ...
    return (
        ...
        <Typography variant="body1" color="text.secondary" mb={4}>
           El modo grupal permite al cuidador o familiar realizar las sesiones de manera colectiva guiadas por un facilitador. No hay registro de progreso, ofreciendo sesiones libres, dinámicas y recreativas que promueven la participación social.
        </Typography>
