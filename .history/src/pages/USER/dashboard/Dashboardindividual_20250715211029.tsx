      ...
      >
        ...
        >
          <CardContent>
            ...
            <Typography variant="body1" color="text.secondary">
              Las actividades son de dos tipos, las que trabajan la memoria a traves de juegos y las que trabajan la atencion atraves de videos entretenidos y preguntas finales de razonamiento. 
            </Typography>
          </CardContent>
        </Card>
      </Box>
