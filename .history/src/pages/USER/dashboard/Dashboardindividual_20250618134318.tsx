      ...
      >
        ...
        >
          <CardContent>
            ...
            <Typography variant="body1" color="text.secondary">
              El sistema permite seleccionar manualmente el nivel de dificultad según las capacidades del usuario. De esta forma, el entrenamiento se ajusta a su ritmo y necesidades específicas, ofreciendo sesiones personalizadas desde nivel básico hasta avanzado.
            </Typography>
          </CardContent>
        </Card>
      </Box>
