...
const GroupSesionRunner: React.FC = () => {
    ...
    return (
        <Box sx={{ width: '100%', height: '100vh', p: 2, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
            {!isFinished ? (
                <Paper elevation={4} sx={{ width: '100%', maxWidth: '960px', height: '90%', p: isMobile ? 1 : 3, borderRadius: 4, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
