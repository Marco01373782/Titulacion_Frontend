    ...
    const handleFinishActivity = async (score: number) => {
        ...
        // Aquí asumimos que la estructura viene como { activity: { ... } }
        // Si tu estructura es diferente, ajusta.
    ...
    // Mapas para armar resourceUrl limpio y consistente
    ...
    // Construir la key resourceUrl para buscar el componente
