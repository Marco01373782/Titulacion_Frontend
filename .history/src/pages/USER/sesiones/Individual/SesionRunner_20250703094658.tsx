...
const SesionRunner: React.FC = () => {
    ...
    if (!ActivityComponent) return (
        <Box sx={{ width: '100%', height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center',  bgcolor: '#fff1f802'}}>
    ...
    return (
        <Box sx={{ width: '100%', height: '89vh',position: 'relative'}}>
            ...
            <Paper elevation={3} sx={{ width: '100%', height: '100%', p: 3, boxSizing: 'border-box', display: 'flex', flexDirection: 'column',  bgcolor: '#f1f02'}}>
