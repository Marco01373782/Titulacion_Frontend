...
const SesionRunner: React.FC = () => {
    ...
    return (
        <Box sx={{ width: '100%', height: '89vh', bgcolor: '#f4ffa' ,background:'red', p: 2 }}>
            <Paper elevation={2} sx={{ width: '100%', height: '100%', p: 3, display: 'flex', flexDirection: 'column',background:'red' }}>
