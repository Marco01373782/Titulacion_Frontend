...
const SesionRunner: React.FC = () => {
    ...
    return (
        <Box sx={{ width: '100%', height: '100vh', bgcolor: '#f4f5fa', p: 2 }}>
...
<Dialog
  ...
  fullWidth
  maxWidth="md"   // más ancho, casi toda la pantalla en desktops
  PaperProps={{
    sx: {
      height: '80vh',          // alto fijo, ocupa buena parte de la pantalla
      bgcolor: '#f0f4f8',      // fondo suave, calmado para adultos mayores
      borderRadius: 3,
      p: 3,
...
>
  <DialogTitle sx={{ fontSize: '1.8rem', fontWeight: 'bold', color: '#3f51b5' }}>
  ...
  <DialogActions sx={{ mt: 2, justifyContent: 'center' }}>
    <Button
      ...
      sx={{ fontSize: '1.2rem', px: 4, py: 1.5, borderRadius: 2 }}
      fullWidth
    >
      ¡Entendido, vamos!
    </Button>
