...
//import audio from '../../../../../src/music/audio.mp3'
...
const SesionRunner: React.FC = () => {
    ...
    if (!ActivityComponent) return (
        <Box sx={{ width: '100%', height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center',  bgcolor: '#fff1f02'}}>
            <Typography variant="h5">No se encontró el componente para: {resourceUrl}</Typography>
        </Box>
    );

    return (
        <Box sx={{ width: '100%', height: '89vh', bgcolor: '#fff1f02',position: 'relative'bgcolor: '#fff1f02'
            <Button
                variant="outlined"
                color="secondary"
                onClick={toggleMusic}
            ...
            <Paper elevation={3} sx={{ width: '100%', height: '100%', p: 3, boxSizing: 'border-box', display: 'flex', flexDirection: 'column',  bgcolor: '#fff1f02'}}>
