...
const SesionRunner: React.FC = () => {
    ...
    return (
        <Box sx={{ width: '100%', height: '89vh',position: 'relative', bgcolor: 'red'}}>
            <Button
                variant="outlined"
                color="secondary"
                onClick={toggleMusic}
            ...
            <Paper elevation={3} sx={{ width: '100%', height: '100%', p: 3, boxSizing: 'border-box', display: 'flex', flexDirection: 'column', bgcolor: 'red'}}>
