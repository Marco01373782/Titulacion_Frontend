        ...
        <Box sx={{ width: '100%', height: '100vh', bgcolor: '#f4f5fa', p: 2 }}>
            <Paper elevation={3} sx={{ width: '100%', height: '100%', p: 3, boxSizing: 'border-box', display: 'flex', flexDirection: 'column' }}>
                ...
                <Dialog
                    ...
                    sx: {
                    height: '60vh', 
                           // alto fijo, ocupa buena parte de la pantalla
                    bgcolor: '#f0f4f8',      // fondo suave, calmado para adultos mayores
                    borderRadius: 3,
                    p: 3,
                    boxShadow: '0 8px 20px rgba(255, 1, 1, 0.2)',
                    display: 'flex',
                ...
                <Box sx={{ flexGrow: 1, display: showInstructionsModal ? 'none' : 'flex', justifyContent: 'center', alignItems: 'center', overflow: 'auto' }}>
