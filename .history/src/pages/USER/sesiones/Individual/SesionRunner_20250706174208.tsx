        ...
        if (currentIndex < activities.length - 1) {
            ...
            setTimeout(async () => {
                try {
                    ...
                    console.log('🧪 Promedio bruto:', averageResponse.data)
                    const rawAverage = Number(averageResponse.data);
                        const activitiesResultAverage = Math.round(rawAverage * 100) / 100; // Deja solo 2 decimales
                    ...
                    const mode = localStorage.getItem('selectedMode') || 'INDIVIDUAL';
                            ...
                            const existingSession = await getSesionUsuarioById(sesionUsuarioId);
                                ...
                                console.error("❌ existingSession no existe o está incompleto:", existingSession);
