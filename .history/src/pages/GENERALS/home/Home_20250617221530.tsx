...
import logoTexto from '../../../assets/imagenes/logo_texto.webp';
        ...
        >
          ...
          >
            <Button 
              ...
              sx={{ flexGrow: 1, mr: 1, display: { xs: 'inline-flex', md: 'inline-flex' } }}
            >
              Misión
            </Button>
            ...
            <Button 
              ...
              sx={{ flexGrow: 1, ml: 1, display: { xs: 'inline-flex', md: 'inline-flex' } }}
            >
              Visión
            </Button>
          </Box>
