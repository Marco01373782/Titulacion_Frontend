        ...
        >
            ...
            >
                ...
                <Box sx={{ textAlign: 'center', maxWidth: 600 }}>
                    ...
                    >
                        <InfoOutlinedIcon sx={{ fontSize: 18, color: theme => theme.palette.primary.main }} />
                        <Typography variant="body2" sx={{ textAlign: 'center' }}>
                            Para una mejor experiencia, se recomienda usar <strong>Google Chrome</strong> como navegador.
                        </Typography>
                    </Box>
