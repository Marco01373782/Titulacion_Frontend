        ...
        const handleRegister = () => {
            ...
            registerUser(payload)
                ...
                .then((response) => {
                    ...
                    navigate('/user/patient-patient-flow');
                })
                .catch((error) => {
        ...
        return (
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    p: 4,
                    position: 'relative',
                    order: { xs: 1, md: 0 }  // Para que en móvil aparezca arriba
                }}>
                    <Box
                        component="img"
                        src={logoMarcaAgua}
                        alt="Logo Fondo"
                        sx={{ position: 'absolute', top: 20, left: 20, width: 100, opacity: 0.1 }}
                    />
                ...
                <Box sx={{
                    ...
                    alignItems: 'center',
                    p: 4,
                    order: { xs: 1, md: 0 }, // Formulario abajo en móvil
                }}>
                    <Paper elevation={6} sx={{
                        ...
                        <Typography variant="h3" textAlign="center" gutterBottom>Registrarse</Typography>
