        ...
        <Box sx={{
            ...
            {!isSmallScreen && (
                <Box sx={{
                    ...
                    <Box
                        ...
                        sx={{ width: 100, mb: 2 }}
                    />
                    <Typography variant="h1" color="primary" sx={{ fontSize: { xs: '2rem', md: '3rem' } }}>
                        NeuroX
                    </Typography>
                    <Typography sx={{ maxWidth: 400, fontWeight: 600, textAlign: 'center', mt: 2 }}>
            ...
            <Box sx={{
                ...
                <Paper elevation={6} sx={{
                    ...
                    <Box component="img" src={logoTexto} alt="Logo" sx={{ width: 120, mb: 3, mx: 'auto' }} />
