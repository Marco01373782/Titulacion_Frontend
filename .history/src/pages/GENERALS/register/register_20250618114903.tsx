    ...
    import { Box, TextField, Button, Typography, Paper, IconButton, InputAdornment, Select, MenuItem, FormControl, InputLabel, FormHelperText, useTheme, Link } from '@mui/material';
                ...
                <Box sx={{
                    ...
                    <Paper elevation={6} sx={{ p: 4, width: '100%', maxWidth: 500, borderRadius: 4 }}>
                        <Box
                            ...
                            src={logoTexto}
                            alt="Logo"
                            sx={{ width: 150, mb: 3, mx: 'auto', display: 'block' }}
                        />

                        <Typography variant="h2" textAlign="center" gutterBottom>Registrarse</Typography>
                        ...
                        <Button variant="contained" fullWidth sx={{ mt: 3, py: 1 }} onClick={handleRegister}>
                            Registrarse
                        </Button>
                        ...
                        <Button variant="outlined" fullWidth sx={{ mt: 4 }} onClick={() => navigate('/home')}>
                            Regresar
                        </Button>
                    </Paper>
                </Box>

                {/* Right Panel (Info + Imagen) */}
                <Box sx={{
                    flex: 1,
