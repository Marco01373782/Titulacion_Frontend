...
const Register = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    password: '',
    confirmPassword: '',
    parentesco: '', // CAMBIO: ahora es string simple
  });
  ...
  useEffect(() => {
    fetchParentescos()
      .then(response => {
        setParentescos(response.data); // asumiendo que response.data es un array de strings
      })
      .catch(() => {
        setParentescos([]);
      });
  ...
  const validateForm = () => {
    ...
    if (!formData.parentesco) errors.parentesco = 'Este campo es obligatorio'; // CAMBIO aquí
  ...
  const handleRegister = () => {
    ...
    const payload = {
      ...
      parentesco: formData.parentesco, // CAMBIO: simple string
    };
          ...
          <div className="row-input">
            <div className="input-group full-width">
              ...
              <select
                ...
                onChange={handleChange}
                className={formErrors.parentesco ? 'error' : ''}
              >
              ...
              {formErrors.parentesco && <span className="error-message">{formErrors.parentesco}</span>}
            </div>
          </div>
