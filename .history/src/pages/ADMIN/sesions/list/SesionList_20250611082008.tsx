    ...
    const handleCreate = () => {
        navigate('/admin/crear-sesiones');
    };

    const handleEdit = (id: number) => {
        navigate(`/admin/editar-sesiones/${id}`);
    };
    ...
    return (
        ...
        <div className="actions-bar">
            ...
            <label>
                ...
                onChange={e => setSelectedDifficulty(e.target.value === 'all' ? 'all' : e.target.value)}
                >
        ...
        <table className="activity-table">
            ...
            {filteredSessions.map(session => (
                ...
                <td>{session.difficulty ? session.difficulty.replace(/_/g, ' ') : ''}</td>
                <td>
