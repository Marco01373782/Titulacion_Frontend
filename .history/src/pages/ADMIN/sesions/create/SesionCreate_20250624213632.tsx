// Versión completamente adaptada a MUI sin usar CSS externo ni Grid
// Estilo responsive y con uso exclusivo de componentes MUI permitidos
      ...
      {sesionId && (
        <Box mt={4}>
          ...
          <Stack spacing={2} direction={isMobile ? 'column' : 'row'}>
            <Button variant="outlined" onClick={handleAsignarManual} disabled={loading}>Asignar manualmente</Button>
