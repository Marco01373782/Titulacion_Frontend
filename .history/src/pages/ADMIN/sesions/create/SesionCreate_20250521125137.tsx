...
import ActivitySelector from '../../../../components/modal/ActivitySelector';
...
const SesionCreate: React.FC = () => {
  ...
  const handleAsignarAuto = () => {
    ...
    assignActivitiesAuto(sesionId)
      .then(() => {
        ...
        // 👇 Redirigir después de asignar automáticamente
        setTimeout(() => {
  ...
  // 🔎 Filtrar actividades por dificultad seleccionada
