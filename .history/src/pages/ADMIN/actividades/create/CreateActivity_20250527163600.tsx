...
import LoadingOverlay from '../../../../components/modal/Loading/LoadingOverlay';// <-- Importa tu overlay
...
const CreateActivity = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => navigate('/app/gestionar-actividades'), 1500);
    } catch (error) {
  ...
  return (
    <div className="create-activity-container">
      ...
      {/* Aquí mostramos el overlay de carga */}
      {loading && <LoadingOverlay message="Creando actividad..." />}
