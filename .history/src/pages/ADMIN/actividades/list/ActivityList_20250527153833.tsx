...
const ActivityList = () => {
  ...
  const [deleting, setDeleting] = useState(false); // ✅ Estado para controlar eliminación
  ...
  const confirmDelete = async () => {
    ...
    setDeleting(true); // ✅ Comienza eliminación
    setLoading(true); // ✅ Activa overlay con mensaje
    ...
    try {
      ...
      setDeleting(false);
      setLoading(false); // ✅ Detiene overlay
    }
  };
