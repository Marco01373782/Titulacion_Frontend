...
const Home = () => {
    ...
    const openModal = (type: 'mision' | 'vision') => {
        if (type === 'mision') {
            setModalData({
                title: 'Misión',
                content: "Proporcionar una solución accesible y efectiva de terapia cognitiva para adultos mayores, ayudando a familiares y cuidadores a gestionar el 
                bienestar mental de sus seres queridos. A través de nuestra plataforma, buscamos mejorar la calidad de vida de los adultos mayores con herramientas personalizadas que faciliten su bienestar emocional y cognitivo.'
            });
        } else {
            setModalData({
                title: 'Visión',
